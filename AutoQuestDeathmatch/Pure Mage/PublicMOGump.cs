...
namespace Server.DeathMatch
{
	public class PublicMOGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddLabel(204, 318, 37, @"Pure Mage Turnuvasýna Katýlmak Ýstiyormusunuz ?");
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					if( m.Backpack != null )
					{
						...
						{
							World.Broadcast( 37, false,"{0} itemlerinizi bankanýza koyunuz aksi takdirde silinecektir!", m.Name );
							return;
						}
				...
				case 1:
				{
					m.SendMessage( 1152,"Ýptal Ettiniz");
					break;
				}
			}
		}
