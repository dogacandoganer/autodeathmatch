...
{
	public class DeathMatchGumpWarrior : Gump
	{
		
		public DeathMatchGumpWarrior()
			: base( 0, 0 )
		{
			...
			switch( info.ButtonID )
			{
				case 2:
				{
					if( m.Backpack != null )
					{
						...
						m.Blessed = true;
						m.Paralyzed = true;
						pm.EventType = EventType.AutoWarrior;
