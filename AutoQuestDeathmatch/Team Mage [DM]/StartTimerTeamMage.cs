...
{
	public class StartTimerTeamMage : Timer
	{	
		public Mobile m_Mobile;
		public PlayerMobile pl;
		public int cnt;

		public StartTimerTeamMage(Mobile mob) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
		{
			m_Mobile = mob;
			cnt = 60;
		}
		...
		protected override void OnTick()
		{
			...
			if( cnt == 35 )
			{
				m_Mobile.CloseGump( typeof( PublicTeamMageGump ));
			}			
			...
			if( cnt == 0 )
			{
				...
				{		
					PlayerMobile pm = m_Mobile as PlayerMobile;
					if( pm.EventType == EventType.ATeamMage || pm.EventType == EventType.BTeamMage )
					{
						pm.Blessed = false;
						pm.Frozen = false;
						pm.Squelched = false;
						...
						pm.PlaySound( 0x1F5 );
						pm.SendMessage( 43,"Baþlayýn! Düþmanlarýnýzý Öldürün");
						pm.Warmode = true;
					}	
				}
