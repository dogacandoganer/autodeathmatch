...
{
	public class StartTimerMage : Timer
	{	
		public Mobile m_Mobile;
		public PlayerMobile pl;
		public int cnt;

		public StartTimerMage(Mobile mob) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
		{
			m_Mobile = mob;
			cnt = 60;
		}
		...
		protected override void OnTick()
		{
			...
			if( cnt == 35 )
			{
				m_Mobile.CloseGump( typeof( DeathMatchGumpMage ));
			}
